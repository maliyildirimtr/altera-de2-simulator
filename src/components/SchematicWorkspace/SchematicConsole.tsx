...
export const SchematicConsole: React.FC<SchematicConsoleProps> = ({
  ...
  return (
    ...
    >
      {/* Console Tab Bar */}
      <div
        className="h-8 px-3 flex items-center justify-between shrink-0 select-none"
        style={{
      ...
      >
        {activeTab === 'console' ? (
          ...
          <div data-testid="problems-list" style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
